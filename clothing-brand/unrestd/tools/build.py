"""Build everything for the UNRESTD brand kit.

    python3 clothing-brand/unrestd/tools/build.py   # logos, mockup SVGs, brand-book.html (template + body), print.html
    node    clothing-brand/unrestd/tools/render.js  # PNG mockups, print files, brand sheet
"""
import re
